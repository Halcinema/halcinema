<header class="admin_header">
    ...
    <ul class="admin_header_list">
        <li class="admin_header_list_item admin_header_list_item_ttl"><?= $pageTitle ?></li>
        <li class="admin_header_list_item">所属：<?= $AdminTheName ?></li>
        <li class="admin_header_list_item">管理者：<?= $AdminName ?></li>
...
<nav class="admin_gnav">
    <ul class="admin_gnav_list">
        ...
        <li class="admin_gnav_list_item"><a href="/halcinema/admin/foods/"><i class="fa fa-cutlery" aria-hidden="true"></i>フード管理</a></li>
        <li class="admin_gnav_list_item"><a href="/halcinema/admin/member/"><i class="fa fa-users" aria-hidden="true"></i>会員管理</a></li>
    </ul>
</nav>
