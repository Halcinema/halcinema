    ...
    <div class="movie_block" aria-haspopup="true">
      ...
      <div class="movie_text">
        ...
        <ul class="info_movie">
          ...
          <li class="info_left" style="background-color:white;color:orangered;border:1px solid orangered;box-sizing:border-box;opacity:1;">公開予定</li>
