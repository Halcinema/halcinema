...
<?php include("header.php"); ?>
    <div id="wrapper">
<h1 class="page_name">グッズ情報</h1>
<section class="clearfix">


<h2 class="contents_name">おすすめ情報</h2>
    
<ul class="topic">
    <li><img src="images/lemonade.jpg" width="400px"><p>シュワッとおいしい！<br>プレミアムソーダ・レモネード販売中！</p></li>
    <li><img src="images/mango.jpg" width="400px"><p>GODIVAから期間限定！<br>ショコリキサー販売中！</p></li>
</ul>
    
<h2 class="contents_name">フード</h2>
  <div id="goodsbox">
    <div id="leftbox">
      <div class="goodsbox">
        <h3>ソフトドリンクSOFT DRINK</h3>
        <ul>
  ...
  <div id="goodsother clearfix">
    <h2 class="contents_name">無料貸出サービス</h2>
    <ul>
      <li class="service">チャイルドシート</li>
      ホワイエ入り口にて係員にお申し出ください。
      <li class="service">膝掛け用ブランケット</li>
      ホワイエ入り口にて係員にお申し出ください。※数に限りがございます。ご了承下さい。
      <li class="service">難聴者向けヘッドフォン </li>
      入場時に係員にお申し出下さい。※数に限りがございます。ご了承下さい。
      <h2 class="contents_name">鑑賞マナー向上への取り組み</h2>
      お客様へのお願い
